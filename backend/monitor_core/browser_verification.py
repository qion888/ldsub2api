...
class BrowserVerificationManager:
    ...
    WAF challenges are still completed by the operator in the browser window. The
    manager only automates the queue, reuses the browser profile, and resumes the
    remaining shops after the challenge is cleared.
    """
