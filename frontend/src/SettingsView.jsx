    ...
    <div className="settings-layout">
      ...
      <div className="settings-content">
        ...
        {loading ? <div className="settings-state" role="status"><RefreshCw size={18} className="spin"/>正在读取设置</div> : tab === 'profile' ? <section className="settings-section profile-section">
          ...
          <div className="settings-form-grid">
            <label><span>运行模式</span><select value={settingsMode} onChange={event => setSettingsMode(event.target.value)}><option value={AUTH_MODES.SELF_USE}>自用模式</option><option value={AUTH_MODES.EXTERNAL}>对外模式</option></select></label>
